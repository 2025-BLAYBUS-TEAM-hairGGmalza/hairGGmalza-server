...
public class DesignerController {
    ...
    @GetMapping("")
    public ApiResponse<DesignerInfos> getAllDesigners(@RequestParam(name = "page", defaultValue = "0") Integer page) {
        Page<Designer> designers = designerService.getDesigners(page);

        return ApiResponse.success("모든 디자이너 조회 성공", DesignerConverter.toDesignerInfoList(designers));
    }
}
